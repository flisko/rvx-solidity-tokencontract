...
contract RVXToken is MinterRole, Ownable, IERC20 {
    ...
    function changeTestTokenAmount(uint256 amount) public onlyOwner returns(bool) {
        testTokenAmount = amount * 1000000000000000000;
        return true;
    }

    function transferTestToken(address wallet) public isFaucetEnabled returns(bool) {
